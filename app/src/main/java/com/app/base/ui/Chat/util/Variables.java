...
public class Variables {
    ...
    public static String gif_api_key1="eJydZn6a6VtgG8pPhOpB7ySMgen3KpQP";

    // Bottom two variable Related with in App Subscription
    //First step get licencekey
    public static String licencekey="\n" +
            "\n";
    ...
    public static String domain="http://sub.tiktalkapp.com/API/index.php?p=";
    ...
    public static String savetestResult=domain+"addTestResult";
}
