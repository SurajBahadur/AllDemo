...
class EncryptedPreferences(context: Context) : SharedPreferences {
    ...
    override fun getStringSet(key: String?, defaultValues: MutableSet<String>?): MutableSet<String> {
        val encryptedSet = sFile.getStringSet(encrypt(key.toString()), null)
                ?: return defaultValues!!
        val decryptedSet = HashSet<String>(encryptedSet.size)
        for (encryptedValue in encryptedSet) {
            decryptedSet.add(decrypt(encryptedValue))
    ...
    override fun getString(key: String?, defValue: String?): String? {
        val encryptedValue = sFile.getString(encrypt(key.toString()), null)
    ...
    inner class EncryptedEditor : SharedPreferences.Editor {
        ...
        override fun putString(key: String?, value: String?): SharedPreferences.Editor {
            mEditor.putString(encrypt(key.toString()), encrypt(value.toString()))
            return this
        }
    }
}